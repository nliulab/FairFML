...
def find_best_local_lambda(site, total_clients, metric_diff=0.005, metric='accuracy', out_file=None):
    result_lst = []
...
def find_lambda_for_one_site(site, total_clients):
    if not os.path.exists('outputs/adult/local'):
        os.mkdir('outputs/adult/local')
